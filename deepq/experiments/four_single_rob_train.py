...
from p2os_test.src.fifth_edition_gpw import set_gpw_num
...
def trainer(lock1, net_list, mem_queue, total_step, end_train_flag, update_flag):
    ...
    parser.add_argument('--num-timesteps', type=int, default=int(2*10e6))  # 10e6
...
def actor(lock1, net_list, mem_queue, total_step, end_train_flag, update_flag, actor_num):
    ...
    acparser.add_argument('--acenv', help='environment ID', default='FifthRobotGpw-v0')
    ...
    acparser.add_argument('--acnum-timesteps', type=int, default=int(5*10e5))  # 10e6
