...
class FifthRobGpw(gym.Env):
    ...
    def reset(self):
        ...
        self.state = np.append(self.state, [int(self.distance_to_goal()*6), int(self.state_polar_angle),
    ...
    def get_gazebo_state(self):
        ...
        # robot_polar_angle += math.pi
        robot_polar_angle = round(robot_polar_angle*10, 1)
